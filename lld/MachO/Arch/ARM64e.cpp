...
#define B(x) RelocAttrBits::x
    ...
    {"ADDEND", B(ADDEND)},
    // AUTHENTICATED_POINTER  (64-bit absolute, external or local)
...
ARM64e::ARM64e() : ARM64Common(LP64()) {
  ...
  cpuSubtype = MachO::CPU_SUBTYPE_ARM64E_WITH_PTRAUTH_VERSION(/*version*/ 0,
    /*kernel*/  false);
...
void ARM64e::applyOptimizationHints(uint8_t *outBuf, const ObjFile &obj) const {
